...
from realur5_utils import base_to_world, world_to_base
...
class Lipa3DEnv(Env):
    ...
    def step(self, action, rescale_needed=True, verbose=False):
        ...
        left_deltas[2] = rescaled_action[2]
    ...
    def _get_obs(self, rescale_needed=True):
        ...
        world_left_pose, world_right_pose = base_to_world(final_left_pose, final_right_pose)
        obs = world_left_pose[0:3]
...
if __name__ == "__main__":
    ...
    workspace = [
        [-0.630, -0.481], # x lim
        [-0.613, -0.163], # y lim
        [-0.613, -0.163] # some z lim to be fixed (in world space)
    ]
